...
## Customer Service Agent Phase 1

智能客服 Agent 阶段一采用单 Agent 架构：
...
阶段一不使用多 Agent，不接入 RAGFlow，不连接真实商城、订单、物流、售后或人工客服系统。客服 Agent 不设置为全局默认 Agent。

详细规范见：

- `.ai/12_Customer_Service_Agent_Architecture.md`
- `.ai/13_Customer_Service_Business_Rules.md`
- `.ai/14_Product_Catalog_and_Recommendation.md`
- `.ai/15_Customer_Service_Evaluation_Plan.md`
