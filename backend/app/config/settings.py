...
class Settings(BaseSettings):
    ...
    DOCUMENT_IDENTITY_LLM_ENABLED: bool = False
    ...
    QUERY_REWRITE_MAX_LENGTH: int = 300
    QUERY_REWRITE_FAIL_OPEN: bool = True
    DOCUMENT_ROUTER_ENABLED: bool = True
    DOCUMENT_ROUTER_FAIL_OPEN: bool = True
    DOCUMENT_ROUTER_MAX_CANDIDATES: int = 20
    QUERY_UNDERSTANDING_ENABLED: bool = True
    QUERY_UNDERSTANDING_LLM_ENABLED: bool = False
    QUERY_UNDERSTANDING_TIMEOUT_MS: int = 50
    QUERY_UNDERSTANDING_FAIL_OPEN: bool = True
    ...
    RETRIEVAL_PER_DOCUMENT_TOP_K: int = 5
    ...
    RERANK_MULTI_DOCUMENT_DIVERSITY_ENABLED: bool = True
    RERANK_MULTI_DOCUMENT_MAX_PER_DOCUMENT: int = 3
    RERANK_MULTI_DOCUMENT_MIN_DOCUMENTS: int = 2
    RERANK_MULTI_DOCUMENT_FAIL_OPEN: bool = True
    ...
    CONTEXT_MULTI_DOCUMENT_DIVERSITY_ENABLED: bool = True
    CONTEXT_MULTI_DOCUMENT_MAX_PER_DOCUMENT: int = 4
    CONTEXT_MULTI_DOCUMENT_MIN_DOCUMENTS: int = 2
    CONTEXT_MAX_CHARS: int = 8000
    CONTEXT_MAX_CHUNKS: int = 12
    CONTEXT_MAX_CHARS_PER_DOCUMENT: int = 4000
