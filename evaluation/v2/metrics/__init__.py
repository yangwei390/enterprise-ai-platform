from evaluation.v2.metrics.agent import (
    ...
    ConfirmationGuardMetric,
    FinalAnswerKeywordCoverageMetric,
    LoopIterationsMetric,
    ManualDocumentScopeMetric,
    ProductConstraintMatchMetric,
    RecommendationCountMetric,
...
def get_metric(name: str) -> BaseMetric:
    metrics: dict[str, BaseMetric] = {
        ...
        "recommendation_count": RecommendationCountMetric(),
        "confirmation_guard": ConfirmationGuardMetric(),
        "manual_document_scope": ManualDocumentScopeMetric(),
        "product_constraint_match": ProductConstraintMatchMetric(),
...
def list_metrics() -> list[str]:
    return sorted(
        [
            ...
            "confirmation_guard",
            "manual_document_scope",
            "product_constraint_match",
            "tool_success",
            "result_match",
            "result_contains",
            "timeout",
